...
" Source:           https://github.com/hynek/vim-python-pep8-indent/blob/master/indent/python.vim
...
setlocal tabstop=2  " robinjia: Changed from 4 to 2
setlocal softtabstop=2  " robinjia: Changed from 4 to 2
setlocal shiftwidth=2  " robinjia: Changed from 4 to 2
...
function! s:indent_like_opening_paren(lnum)
    ...
    if nothing_after_opening_paren
        if starts_with_closing_paren
            ...
            let res = base + s:sw() * 2  " robinjia: added the '* 2'
        endif
    else
